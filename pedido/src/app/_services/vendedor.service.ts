...
export class VendedorService {
  ...
  private create(vendedore: VendedorEntity): Observable<VendedorEntity> {
    return this.http.post<VendedorEntity>(environment.urlSaaS + '/vendedores', vendedore);
  }
  private update(vendedore: VendedorEntity): Observable<VendedorEntity> {
    return this.http.put<VendedorEntity>(environment.urlSaaS + '/vendedores/' + vendedore.id, vendedore);
  }
